...
# ---------------------------------------------------------------------------
# Action log schemas (new)
# ---------------------------------------------------------------------------

class PestActionLogCreate(BaseModel):
    action:   str
    language: Optional[str] = "en"
    crop:     Optional[str] = None       # pest's crop for RAG context
    pest_name: Optional[str] = None      # pest name for RAG context


class PestActionLogOut(BaseModel):
    id:        str
    report_id: str
    action:    str
